...
$result_user = mysqli_query($conn, "SELECT C.nm_cust, C.telp_cust, C.email_cust, C.alamat_cust, C.wilayah_cust, U.username, U.password, U.jk_user, U.foto
                                                  FROM tbl_customer C
...
if (isset($_POST["submit"])) {
    ...
    $simpan_cust = mysqli_query($conn, "UPDATE tbl_customer SET nm_cust = '$nm_cust', telp_cust = '$telp_cust', email_cust = '$email_cust', alamat_cust = '$alamat_cust', wilayah_cust = '$wilayah_cust' WHERE id_user = $id_user");
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="" method="POST" enctype="multipart/form-data">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="nm_cust" id="nm_cust" value="<?php echo $row_user["nm_cust"] ?>" placeholder="Masukkan Nama Lengkap Anda" required>
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="telp_cust" id="telp_cust" value="<?php echo $row_user["telp_cust"] ?>" placeholder="Masukkan Nomor Telepon Anda" required>
                                        </div>
                                        <div class="mb-3">
                                            <label for="email_cust" class="form-label">Email :</label>
                                            <input type="text" class="form-control" name="email_cust" id="email_cust" value="<?php echo $row_user["email_cust"] ?>" placeholder="Masukkan Email Anda" required>
                                        </div>
                                        <div class="mb-3">
                                            <label for="alamat_cust" class="form-label">Alamat :</label>
                                            <textarea class="form-control" name="alamat_cust" id="alamat_cust" rows="5" placeholder="Masukkan Alamat Lengkap Anda" required><?php echo $row_user["alamat_cust"] ?></textarea>
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="input-group">
                                                    <select name="wilayah_cust" id="wilayah_cust" class="form-control">
                                                        ...
                                                        <option value="1" <?php if ($row_user["wilayah_cust"] == 1) echo "SELECTED"; ?>>Banjarmasin Utara</option>
                                                        <option value="2" <?php if ($row_user["wilayah_cust"] == 2) echo "SELECTED"; ?>>Banjarmasin Barat</option>
                                                        <option value="3" <?php if ($row_user["wilayah_cust"] == 3) echo "SELECTED"; ?>>Banjarmasin Tengah</option>
                                                        <option value="4" <?php if ($row_user["wilayah_cust"] == 4) echo "SELECTED"; ?>>Banjarmasin Timur</option>
                                                        <option value="5" <?php if ($row_user["wilayah_cust"] == 5) echo "SELECTED"; ?>>Banjarmasin Selatan</option>
                                                    </select>
                                                    <span class="input-group-text">
                                                        <i class="fas fa-caret-down"></i>
                                                    </span>
