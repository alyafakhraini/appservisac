...
if (isset($_POST["submit"])) {
    ...
    $simpan = mysqli_query($conn, "INSERT INTO tbl_jenis_servis VALUES (NULL, '$nm_servis', '$deskripsi', '$biaya', '$durasi', '$gambar')");

    if ($simpan) {
        header("Location: jenis.php");
    } else {
        header("Location: jenis-tambah.php");
    }
}
...
<head>
    <!-- Title -->
    <title>SERASI - Tambah Jenis Servis</title>
    <!-- Required Meta Tag -->
                ...
                <div class="card bg-light-info shadow-none position-relative overflow-hidden">
                    <div class="card-body px-4 py-1">
                        <div class="row align-items-center">
                            <div class="col-9">
                                <h4 class="fw-semibold mb-8">Tambah Jenis Servis</h4>
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a class="text-muted " href="index.php">Dashboard</a></li>
                                        <li class="breadcrumb-item"><a class="text-muted " href="user.php">Jenis Servis</a></li>
                                        <li class="breadcrumb-item" aria-current="page">Tambah Jenis Servis</li>
                                    </ol>
                                </nav>
                            </div>
                            <div class="col-3">
                ...
                <section class="datatables">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <p class="card-subtitle mb-3">Silahkan menambahkan <b>Jenis Servis</b> Baru pada form dibawah ini...!</p>
                                    <form action="" method="POST" enctype="multipart/form-data">
                                        <div class="mb-3">
                                            <label for="nm_servis" class="form-label">Servis :</label>
                                            <input type="text" class="form-control" name="nm_servis" id="nm_servis" placeholder="Masukkan Jenis Servis" required>
                                        </div>
                                        <div class="mb-3">
                                            <label for="deskripsi" class="form-label">Deskripsi :</label>
                                            <textarea class="form-control" name="deskripsi" id="deskripsi" rows="5" placeholder="Masukkan deskripsi singkat mengenai servis"></textarea>
                                        </div>
                                        <div class="mb-3">
                                            <label for="biaya" class="form-label">Biaya :</label>
                                            <input type="number" class="form-control" name="biaya" id="biaya" placeholder="Masukkan biaya servis" required>
                                        </div>
                                        <div class="mb-3">
