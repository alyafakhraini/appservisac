...
<head>
    <!-- Title -->
    <title>SERASI - Servis Selesai</title>
    <!-- Required Meta Tag -->
                            ...
                            <div class="col-9">
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item" aria-current="page">Data Servis Selesai</li>
                                    </ol>
                                </nav>
                            </div>
                            <div class="col-3">
            ...
            var table = $('#example2').DataTable({
                ...
                buttons: [{
                    ...
                    action: function(e, dt, node, config) {
                        window.location.href = `riwayat-print.php?bulan=${bulan}&&tahun=${tahun}`;
                    }
                }],
                order: [1, 'asc'],
                scrollX: true
