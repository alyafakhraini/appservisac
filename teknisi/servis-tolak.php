...
$row_id_teknisi = mysqli_fetch_assoc($id_teknisi_query);
$id_teknisi_lama = $row_id_teknisi['id_teknisi'];
...
if ($id_teknisi_baru == 0) {
    ...
    $confirm = mysqli_query($conn, "UPDATE tbl_servis SET id_teknisi = '$id_teknisi_baru' WHERE id_servis = '$id_servis'");
}
if ($confirm) {
    header("Location: index.php");
} else {
    header("Location: servis-tolak.php?id=$id_servis");
}
